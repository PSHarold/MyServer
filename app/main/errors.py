...
class Error(Enum):
    ...
    ARGUMENT_MISSING = 609
    WRONG_FIELD_TYPE = 610  # field类型错误
    BASE64_ERROR = 620  # POST to avatar BASE64字符串错误
    FACE_TRAINING_NOT_DONE = 621
    IMAGE_CONTAINS_NO_FACE = 622
    BAD_QR_CODE = 623
    FACE_DOES_NOT_MATCH = 624
    WRONG_EMAIL_ADDRESS = 625
    EMAIL_NOT_ACTIVATED = 626
    ...
    ASK_FOR_LEAVE_HAS_BEEN_DISAPPROVED = 952
    ASK_FOR_LEAVE_STILL_PENDING = 953
    ...
    TEST_EXPIRED = 930
    TEST_HAVENT_BEGUN = 931
    TEST_ALREADY_TAKEN = 932
    TEST_STILL_ONGOING = 933
    YOU_HAVENT_TAKEN_THE_TEST = 934
    BAD_STUDENT_TEST_RESULT = 935
    ALREADY_CHECKED_IN = 936
...
def error500(e):
    return make_response(jsonify({'error_msg': 'Unknown Internal Error', 'error_code': 500}), 500)
