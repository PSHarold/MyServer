...
class Period:
    PERIOD_LIST = []
    def __init__(self, num, begin_at, end_at, room_id=None, teach_day=None):
    ...
    @staticmethod
    def get_period(num):
        p = Period.PERIOD_LIST[num]
        return Period(num, p.begin_at, p.end_at)


zero = Period(0, '0:00:00', '08:00:00')
...
si = Period(6, '18:45:00', '21:05:00')
se = Period(7, '21:05:01', '23:59:59')
Period.PERIOD_LIST = [zero, f, s, t, fo, fi, si, se]
